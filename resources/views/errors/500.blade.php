        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div class="rounded-xl border border-gray-200 bg-white p-10 text-center shadow-sm">
                    ...
                    <h1 class="mt-4 text-xl font-semibold text-gray-900">Error del servidor</h1>
                    <p class="mt-2 text-sm text-gray-600">Algo salió mal. Inténtalo de nuevo en unos minutos.</p>
